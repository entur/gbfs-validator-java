...
class GbfsJsonValidatorTest {
  ...
  void testSuccessfulV1_1Validation() {
    ...
    deliveryMap.put(
      "gbfs_versions",
      getFixture("fixtures/v1.1/gbfs_versions.json")
    );
    deliveryMap.put(
      "system_information",
  ...
  void testSuccessfulV2_0Validation() {
    ...
    deliveryMap.put(
      "gbfs_versions",
      getFixture("fixtures/v2.0/gbfs_versions.json")
    );
    deliveryMap.put(
      "system_information",
  ...
  void testSuccessfulV2_1Validation() {
    ...
    deliveryMap.put(
      "gbfs_versions",
      getFixture("fixtures/v2.1/gbfs_versions.json")
    );
    deliveryMap.put(
      "system_information",
    ...
    deliveryMap.put(
      "vehicle_types",
      getFixture("fixtures/v2.1/vehicle_types.json")
    );
    deliveryMap.put(
      "station_information",
    ...
    deliveryMap.put(
      "station_status",
      getFixture("fixtures/v2.1/station_status.json")
    );
    deliveryMap.put(
      "free_bike_status",
    ...
    deliveryMap.put(
      "system_hours",
      getFixture("fixtures/v2.1/system_hours.json")
    );
    deliveryMap.put(
      "system_calendar",
      getFixture("fixtures/v2.1/system_calendar.json")
    );
    deliveryMap.put(
      "system_regions",
      getFixture("fixtures/v2.1/system_regions.json")
    );
    deliveryMap.put(
      "system_alerts",
      getFixture("fixtures/v2.1/system_alerts.json")
    );
    deliveryMap.put(
      "geofencing_zones",
  ...
  void testSuccessfulV2_2Validation() {
    ...
    deliveryMap.put(
      "gbfs_versions",
      getFixture("fixtures/v2.2/gbfs_versions.json")
    );
    deliveryMap.put(
      "system_information",
    ...
    deliveryMap.put(
      "vehicle_types",
      getFixture("fixtures/v2.2/vehicle_types.json")
    );
    deliveryMap.put(
      "station_information",
    ...
    deliveryMap.put(
      "station_status",
      getFixture("fixtures/v2.2/station_status.json")
    );
    deliveryMap.put(
      "free_bike_status",
    ...
    deliveryMap.put(
      "system_hours",
      getFixture("fixtures/v2.2/system_hours.json")
    );
    deliveryMap.put(
      "system_calendar",
      getFixture("fixtures/v2.2/system_calendar.json")
    );
    deliveryMap.put(
      "system_regions",
      getFixture("fixtures/v2.2/system_regions.json")
    );
    deliveryMap.put(
    ...
    deliveryMap.put(
      "system_alerts",
      getFixture("fixtures/v2.2/system_alerts.json")
    );
    deliveryMap.put(
      "geofencing_zones",
  ...
  void testSuccessfulV2_3Validation() {
    ...
    deliveryMap.put(
      "gbfs_versions",
      getFixture("fixtures/v2.3/gbfs_versions.json")
    );
    deliveryMap.put(
      "system_information",
    ...
    deliveryMap.put(
      "vehicle_types",
      getFixture("fixtures/v2.3/vehicle_types.json")
    );
    deliveryMap.put(
      "station_information",
    ...
    deliveryMap.put(
      "station_status",
      getFixture("fixtures/v2.3/station_status.json")
    );
    deliveryMap.put(
      "free_bike_status",
    ...
    deliveryMap.put(
      "system_hours",
      getFixture("fixtures/v2.3/system_hours.json")
    );
    deliveryMap.put(
      "system_calendar",
      getFixture("fixtures/v2.3/system_calendar.json")
    );
    deliveryMap.put(
      "system_regions",
      getFixture("fixtures/v2.3/system_regions.json")
    );
    deliveryMap.put(
      "system_pricing_plans",
    ...
    deliveryMap.put(
      "system_alerts",
      getFixture("fixtures/v2.3/system_alerts.json")
    );
    deliveryMap.put(
      "geofencing_zones",
  ...
  void testSuccessfulV3_0Validation() {
    ...
    deliveryMap.put(
      "gbfs_versions",
      getFixture("fixtures/v3.0/gbfs_versions.json")
    );
    deliveryMap.put(
      "system_information",
    ...
    deliveryMap.put(
      "vehicle_types",
      getFixture("fixtures/v3.0/vehicle_types.json")
    );
    deliveryMap.put(
      "station_information",
    ...
    deliveryMap.put(
      "system_regions",
      getFixture("fixtures/v3.0/system_regions.json")
    );
    deliveryMap.put(
      "system_pricing_plans",
    ...
    deliveryMap.put(
      "system_alerts",
      getFixture("fixtures/v3.0/system_alerts.json")
    );
    deliveryMap.put(
      "geofencing_zones",
  ...
  void testParseError() {
    GbfsJsonValidator validator = new GbfsJsonValidator();
    String invalidJson =
      "{ \"name\": \"test_feed_parse_error.json\", \"data\": {";
    ...
    assertTrue(
      ...
      "Validation errors should be empty for a parse error."
    );
    assertFalse(
      result.validatorErrors().isEmpty(),
      "System errors should be present for a parse error."
    );

    assertEquals(
      1,
      result.validatorErrors().size(),
      "There should be one system error."
    );
    ValidatorError validatorError = result.validatorErrors().get(0);
    assertEquals(
      "PARSE_ERROR",
      validatorError.error(),
      "System error code should be PARSE_ERROR."
    );
    assertTrue(
      validatorError
        .message()
        .contains(
          "A JSONObject text must end with '}' at 49 [character 50 line 1]"
        ),
      "System error message should indicate unterminated object."
    );
  ...
  void testReadError() throws IOException {
    ...
    assertTrue(
      result.errors().isEmpty(),
      "Validation errors should be empty for a read error."
    );
    assertNull(
      result.fileContents(),
      "File contents should be null for a read error."
    );
    ...
    assertEquals(
      "READ_ERROR",
      validatorError.error(),
      "System error code should be READ_ERROR."
    );
    assertTrue(
      validatorError.message().contains("IOException reading stream"),
